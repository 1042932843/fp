 ...
 * @DESCRIPTION:
 */
public class ResponsibilityGroupAdapter extends RecyclerView.Adapter<ResponsibilityGroupAdapter.ViewHolder>{

    private List<ResponsibilityGroup> home;
    private Context context;

    public ResponsibilityGroupAdapter(List<ResponsibilityGroup> home, Context context) {
        this.home = home;
        this.context=context;
    }

    public void updateData(List<ResponsibilityGroup> home) {
