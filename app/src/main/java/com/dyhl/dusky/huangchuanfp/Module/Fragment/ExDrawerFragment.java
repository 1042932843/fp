...
public class ExDrawerFragment extends BaseFragment {
    DrawerLayout drawer;
    ExCommonData logCommonData;
    String code;
    @BindView(R.id.outp)
    Switch outp;
    ...
    public void OK(){
       /* if(reset){
        ...
        logCommonData.setName(name.getText().toString());
        logCommonData.setTitle(title.getText().toString());
        reset=false;
        if(!checkBox.isChecked()){
            logCommonData.setIspublic("");
        }else{
            if(outp.isChecked()){
                logCommonData.setIspublic("公开");
            }else{
                logCommonData.setIspublic("屏蔽");
            }
        }
    ...
    public void reset(){
        ...
        reset=true;
        logCommonData=new ExCommonData();
    }
    ...
    public static ExDrawerFragment newInstance(DrawerLayout drawer) {
        ExDrawerFragment fragment=  new ExDrawerFragment();
    ...
    public int getLayoutResId() {
        return R.layout.layout_drawer_exdrawer;
