 ...
 * @DESCRIPTION:
 */
public class GzdInfoAdapter extends RecyclerView.Adapter<GzdInfoAdapter.ViewHolder>{

    private List<GzdInfo> home;
    private Context context;

    public GzdInfoAdapter(List<GzdInfo> home, Context context) {
        this.home = home;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // 实例化展示的view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.gzd_item, parent, false);
        // 实例化viewholder
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            sexlayout=(RelativeLayout) itemView.findViewById(R.id.sex);
