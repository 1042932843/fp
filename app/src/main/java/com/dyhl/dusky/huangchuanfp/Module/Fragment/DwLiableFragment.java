...
import com.dyhl.dusky.huangchuanfp.Module.DwDetailActivity;
...
public class DwLiableFragment extends BaseFragment {
    ...
    public static DwLiableFragment newInstance(BFDWInfo bfdwInfo) {
        DwLiableFragment fragment=  new DwLiableFragment();
    ...
    public void getZZRList(){
        RetrofitHelper.getCommonListAPI()
                .getZZRList(permissions,bfdwInfo.getDepartmentid(),currentPage,pageSize)
