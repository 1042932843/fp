...
public class PkcDetailZcgzdInfoFragment extends BaseFragment {
    PkcInfo pkcInfo;
    List<GzdInfo> datas;
    ...
    GzdInfoAdapter adapter;
    protected ProgressDialog dialog;

    public static PkcDetailZcgzdInfoFragment newInstance(PkcInfo pkcInfo) {
        PkcDetailZcgzdInfoFragment fragment=  new PkcDetailZcgzdInfoFragment();
    ...
    public void initRec(){
        ...
        datas=new ArrayList<>();
        adapter=new GzdInfoAdapter(datas,getActivity());
    ...
    public void loadData(){
        ...
        RetrofitHelper.getPkcListServiceAPI()
                .getZcgzd(pkcInfo.getCode(),currentPage,pageSize)
