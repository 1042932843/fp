...
public class LogByTownFragment extends BaseFragment {
    ...
    public static LogByTownFragment newInstance(String type) {
        LogByTownFragment fragment=  new LogByTownFragment();
        fragment.type=type;
        return fragment;
    }
    @Override
